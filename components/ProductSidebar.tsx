...
export default function ProductSidebar({ activeCategory, assistanceText }: ProductSidebarProps) {
 ...
 className="flex items-center gap-2 bg-gray-100 text-gray-900 px-4 py-2 text-[11px] font-bold uppercase tracking-wider rounded transition-colors"
 >
 ...
 <button
 onClick={() => setIsMobileOpen(false)}
 className="text-gray-500 hover:text-gray-900 p-2 bg-gray-100 rounded-full transition-colors"
 >
