      ...
      <div className="bg-white text-gray-900 font-sans w-full overflow-x-clip">
        ...
        <div className="relative overflow-hidden">
          <section className="relative min-h-[min(600px,85vh)] sm:min-h-[600px] flex items-center justify-center flex-col text-center px-4 sm:px-6 py-16 sm:py-20 md:py-24">
            <img
              src={getContent('home.hero.background_image', 'https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&w=2000&q=80')}
              alt="Workspace"
            ...
            <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center w-full">
              <h1 className="text-[clamp(1.75rem,5vw,3rem)] font-bold text-white mb-2 tracking-tight">
                {getContent('home.hero.subtitle', 'Since 1964')}
              </h1>
              <h1 className="text-[clamp(1.75rem,5vw,3rem)] font-bold text-[#EB5324] mb-4 sm:mb-6 tracking-tight">
                {getContent('home.hero.title', 'Building Workspaces That Perform')}
              </h1>

              <p className="text-gray-200 text-sm md:text-base max-w-2xl mx-auto font-medium leading-relaxed mb-6 sm:mb-8 px-2">
                {getContent('home.hero.description', 'Precision engineering meets architectural elegance. We deliver premium turnkey solutions for the modern corporate environment.')}
              </p>

              <Link
                href={getContent('home.hero.cta_link', '/products/office-sets')}
              ...
              >
                {getContent('home.hero.cta_text', 'Explore Office Sets')}
            ...
            <div className="bg-white shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)]">
              <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-100 py-8 gap-y-8 md:gap-y-0">
                <div className="flex flex-col items-center justify-center text-center px-4">
                  <span className="text-3xl sm:text-4xl font-bold text-[#EB5324] mb-2">
                    {getContent('home.stats.stat1.value', '60+')}
                  </span>
                  <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                    {getContent('home.stats.stat1.label', 'Years of Heritage')}
                  </span>
                </div>
                <div className="flex flex-col items-center justify-center text-center px-4">
                  <span className="text-3xl sm:text-4xl font-bold text-[#EB5324] mb-2">
                    {getContent('home.stats.stat2.value', '300+')}
                  </span>
                  <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                    {getContent('home.stats.stat2.label', 'Corporate Clients')}
                  </span>
                </div>
                <div className="flex flex-col items-center justify-center text-center px-4">
                  <span className="text-3xl sm:text-4xl font-bold text-[#EB5324] mb-2">
                    {getContent('home.stats.stat3.value', '500+')}
                  </span>
                  <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                    {getContent('home.stats.stat3.label', 'Workspaces Delivered')}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
            ...
            <div className="text-center md:text-left">
              <h2 className="text-[clamp(1.875rem,4vw,3rem)] font-bold text-gray-900 tracking-tight leading-tight mb-2">
                {getContent('home.legacy.title', 'A Legacy of Craftsmanship')}
              </h2>

              <p className="text-gray-600 text-[13px] leading-relaxed mt-8 mb-6">
                {getContent('home.legacy.description1', 'Founded by Mr. Tahir Hassan Gardezi, HB Furniture has stood as a paragon of industrial excellence since 1964. What began as a visionary pursuit of quality has evolved into a comprehensive institution for workspace creation.')}
              </p>
              <p className="text-gray-600 text-[13px] leading-relaxed mb-10">
                {getContent('home.legacy.description2', 'Our approach blends heritage manufacturing principles with cutting-edge architectural design. We don\'t just supply furniture; we engineer environments that foster productivity, well-being, and corporate prestige.')}
              </p>
            ...
            <div className="relative">
              <div className="relative overflow-hidden rounded-3xl shadow-xl">
                <Image
                  src={getContent('home.legacy.image', 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=1000&q=80')}
        ...
        <section className="py-16 sm:py-20 md:py-24 overflow-hidden">
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
            <div className="text-center mb-10 sm:mb-16">
              <span className="text-[10px] font-bold text-[#EB5324] uppercase tracking-widest mb-2 block">
                {getContent('home.clients.subtitle', 'Our Prestige Clients')}
              </span>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 font-serif">
                {getContent('home.clients.title', 'Trusted By Leading Organizations')}
              </h2>
              <p className="text-gray-600 text-sm md:text-base max-w-2xl mx-auto">
                {getContent('home.clients.description', 'Highlight that HB Furniture has successfully delivered workspace solutions for respected organizations across multiple industries.')}
              </p>
            </div>
        ...
        <section className="relative py-16 sm:py-20 md:py-24 overflow-hidden isolate">
          ...
          <div className="absolute inset-0 z-0">
            <img
              src={getContent('home.cta.background_image', 'https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&w=2000&q=80')}
          ...
          <div className="relative z-10 max-w-[1200px] mx-auto px-4 sm:px-6 text-center">
            <span className="text-[10px] font-bold text-[#EB5324] uppercase tracking-widest mb-2 block">
              {getContent('home.cta.subtitle', 'Let\'s Create Something Great Together')}
            </span>
            <h2 className="text-[clamp(1.75rem,4.5vw,3rem)] font-bold text-white mb-4 font-serif">
              {getContent('home.cta.title', 'Ready To Transform Your Workspace?')}
            </h2>
            <p className="text-gray-200 text-sm md:text-base max-w-2xl mx-auto mb-8 sm:mb-12">
              {getContent('home.cta.description', 'From executive offices to complete workplace solutions, HB Furniture helps organizations create productive environments that inspire performance.')}
            </p>
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-stretch sm:items-center max-w-md sm:max-w-none mx-auto">
              <Link
                href={getContent('home.cta.cta_link', '/contact')}
              ...
              >
                {getContent('home.cta.cta_text', 'Request Consultation')}
                <span className="w-5 h-5 border border-white/50 flex items-center justify-center">
                  →
                </span>
              </Link>
