...
export default async function Storage() {
  ...
  const { data: categories } = await supabase
    .from('categories')
    .select('id')
    .in('slug', ['almirahs', 'storage-cabinets']);
  ...
  return (
    <div className="min-h-screen w-full min-w-0 overflow-x-clip bg-white text-gray-900 font-sans selection:bg-[#E5E0D8]">
      <ProductPageHeader title="Storage" description="Premium storage cabinets and wardrobe solutions designed for offices, homes, and modern interiors." />
