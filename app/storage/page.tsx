...
const products = [
  ...
  // --- Storage Cabinets ---
  {
    ...
    description: 'Classic dark wood cabinet with glass-front upper shelving for books and décor, paired with solid lower cabinet doors featuring decorative brass handles. Elegant executive office storage.',
  },
  {
    name: 'Wooden Bookcase Cabinet with Glass Doors',
    image: '/Screenshot 2026-06-23 233712.png',
    description: 'Light oak finish cabinet combining glass-paneled upper compartments for display with solid wood lower doors, offering tall vertical storage suited for libraries or executive offices.',
  },
  {
    name: 'Walnut & White Sliding Door Cabinet',
    image: '/Screenshot 2026-06-23 233954.png',
    description: 'Modern two-tone storage unit with walnut wood-grain sliding door over an open shelf compartment, set on a white base. Compact design for side storage.',
  },
  {
    name: 'Two-Tone Swing Door Storage Cabinet',
    image: '/Screenshot 2026-06-23 234018.png',
    description: 'Contemporary low cabinet with walnut-finish swing doors and a white frame, featuring a sleek top handle bar and tapered legs. Practical mid-height office storage.',
  },
  {
    name: 'Walnut Cabinet with Lock & Top Handle',
    image: '/Screenshot 2026-06-23 234023.png',
    description: 'Two-tone design with walnut door panels and a white side frame, fitted with a locking mechanism on the top rail for secure document storage.',
  },
  {
    name: 'Grey Steel Storage Cabinet',
    image: '/Screenshot 2026-06-23 233442.png',
    description: 'Minimalist all-grey metal cabinet with double swing doors and a discreet lock, designed for durable and secure storage of files and office supplies.',
  },
  {
    name: 'Tambour Roller Shutter Cabinet',
    image: '/Screenshot 2026-06-23 233450.png',
    description: 'Off-white steel cabinet with a horizontal roll-up tambour shutter door and key lock, ideal for easy-access filing and secure storage in compact office spaces.',
  },
];
...
export default function Storage() {
  return (
    <div className="min-h-screen w-full min-w-0 overflow-x-clip bg-white text-gray-900 font-sans selection:bg-[#E5E0D8]">
      <ProductPageHeader
        title="Storage"
        description="Premium almirahs, wardrobes, and storage cabinets designed for offices, homes, and modern interiors — built for security, organization, and lasting quality."
      />
