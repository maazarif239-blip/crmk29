          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group border border-gray-100 shadow-sm hover:shadow-md transition-shadow bg-white flex flex-col">
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <p className="text-gray-500 text-[11px] leading-relaxed flex-1">
                 Sky blue plastic chair with metal frame, lightweight, stackable and easy to clean design.
                </p>
                <div className="mt-6">
            ...
            <div className="group border border-gray-100 shadow-sm hover:shadow-md transition-shadow bg-white flex flex-col">
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <p className="text-gray-500 text-[11px] leading-relaxed flex-1">
                  Navy blue fabric chair with thick cushioned back aur seat, foldable armrests, height-adjustable mechanism aur rolling caster wheels. Offers great back support for extended study or work hours.
                </p>
                <div className="mt-6">
                  <ContactForPricingLink />
                </div>
            ...
            <div className="group border border-gray-100 shadow-sm hover:shadow-md transition-shadow bg-white flex flex-col">
              <div className="aspect-square bg-[#F5F5F5] p-4 sm:p-6 md:p-8 flex items-center justify-center relative overflow-hidden">
                <img 
                  src="/3.jpg" 
                  alt="Two-Tone Blue Grey chair" 
                  className="w-full h-full object-contain mix-blend-multiply group-hover:scale-105 transition-transform duration-500"
                />
              </div>
              <div className="p-6 flex-1 flex flex-col">
                <h3 className="text-[15px] font-bold text-gray-900 mb-2">Two-Tone Blue Grey chair</h3>
                <p className="text-gray-500 text-[11px] leading-relaxed flex-1">
            ...
            <div className="group border border-gray-100 shadow-sm hover:shadow-md transition-shadow bg-white flex flex-col">
              <div className="aspect-square bg-[#F5F5F5] p-4 sm:p-6 md:p-8 flex items-center justify-center relative overflow-hidden">
                <img 
                  src="/4.jpg" 
                  alt=" Mesh Back Ergonomic chair" 
                  className="w-full h-full object-contain mix-blend-multiply group-hover:scale-105 transition-transform duration-500"
                />
              </div>
              <div className="p-6 flex-1 flex flex-col">
                <h3 className="text-[15px] font-bold text-gray-900 mb-2">Mesh Back Ergonomic chair</h3>
                <p className="text-gray-500 text-[11px] leading-relaxed flex-1">
                  Breathable black mesh-back chair with adjustable armrests, lumbar support aur cushioned seat. Smooth-rolling wheels aur tilt mechanism provide flexible comfort for long hours of studying or working.
                </p>
                <div className="mt-6">
                  <ContactForPricingLink />
                </div>
            ...
            <div className="group border border-gray-100 shadow-sm hover:shadow-md transition-shadow bg-white flex flex-col">
              <div className="aspect-square bg-[#F5F5F5] p-4 sm:p-6 md:p-8 flex items-center justify-center relative overflow-hidden">
                <img 
                  src="/5.jpg" 
                  alt="Foldable Tablet Arm chair" 
                  className="w-full h-full object-contain mix-blend-multiply group-hover:scale-105 transition-transform duration-500"
                />
              </div>
              <div className="p-6 flex-1 flex flex-col">
                <h3 className="text-[15px] font-bold text-gray-900 mb-2">Foldable Tablet Arm chair</h3> 
                <p className="text-gray-500 text-[11px] leading-relaxed flex-1">
            ...
            <div className="group border border-gray-100 shadow-sm hover:shadow-md transition-shadow bg-white flex flex-col">
              <div className="aspect-square bg-[#F5F5F5] p-4 sm:p-6 md:p-8 flex items-center justify-center relative overflow-hidden">
                <img 
                  src="/6.jpg" 
                  alt="Red & Black Classic chair" 
                  className="w-full h-full object-contain mix-blend-multiply group-hover:scale-105 transition-transform duration-500"
                />
              </div>
              <div className="p-6 flex-1 flex flex-col">
                <h3 className="text-[15px] font-bold text-gray-900 mb-2">Red & Black Classic chair</h3>
                <p className="text-gray-500 text-[11px] leading-relaxed flex-1">
            ...
            <div className="group border border-gray-100 shadow-sm hover:shadow-md transition-shadow bg-white flex flex-col">
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <p className="text-gray-500 text-[11px] leading-relaxed flex-1">
                  Black fabric chair with padded seat, armrests, adjustable height aur smooth rolling wheels for comfort.
                </p>
                <div className="mt-6">
                  <ContactForPricingLink />
                </div>
