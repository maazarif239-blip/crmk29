...
export default function HeritageExecutiveWorkstationSeries() {
  return (
    <div className="min-h-screen w-full min-w-0 overflow-x-clip bg-white text-gray-900 font-sans selection:bg-[#E5E0D8]">
      <ProductPageHeader title="Heritage Executive Workstation Series" description="Prestige-grade executive workstations with rich wood veneers, integrated display solutions, and commanding configurations for senior leadership offices." />
{/* Main Content Area */}
