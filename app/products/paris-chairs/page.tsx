...
export default function ParisChairs() {
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans selection:bg-[#E5E0D8]">
        ...
        <section className="relative h-[300px] md:h-[400px] flex items-center justify-center overflow-hidden bg-gray-900">
          ...
          <div className="relative z-10 w-full text-center px-4">
            ...
            <p className="text-gray-200 text-[13px] md:text-sm font-medium leading-relaxed max-w-2xl mx-auto">
              Contemporary elegance meets exceptional comfort. Explore our range of Paris seating engineered for modern corporate office environments.
            </p>
          </div>
        </section>
      </div>
      ...
      <section className="max-w-[1200px] mx-auto px-4 py-12 flex flex-col md:flex-row gap-16">
        ...
        {/* Sidebar */}
        <ProductSidebar activeCategory="/products/paris-chairs" />
            ...
            {[
              {
                name: 'Paris Chair',
                image: '/231.png',
                description: 'The Paris Chair combines a sleek, modern design with premium seating comfort. Featuring elegant contours and a durable build, it\'s an ideal choice for collaborative workspaces, executive suites, and meeting rooms.',
              }
            ].map((product, i) => (
