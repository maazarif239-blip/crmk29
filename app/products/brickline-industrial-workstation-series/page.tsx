...
export default function BricklineIndustrialWorkstationSeries() {
  return (
    <div className="min-h-screen w-full min-w-0 overflow-x-clip bg-white text-gray-900 font-sans selection:bg-[#E5E0D8]">
      <ProductPageHeader title="Brickline Industrial Workstation Series" description="Industrial-grade workstations with robust metal frames, raw material finishes, and heavy-duty configurations for warehouse-style and creative studio offices." />
{/* Main Content Area */}
