...
export default function ContactUs() {
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-gray-900 font-sans selection:bg-[#E5E0D8]">
      ...
      <section className="max-w-[800px] mx-auto px-4 -mt-24 relative z-20 mb-24">
        <div className="bg-white shadow-2xl rounded-sm overflow-hidden p-10 md:p-16 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 font-serif">Reach Out on WhatsApp</h2>
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center items-center">
            <a 
              ...
              className="flex flex-col items-center justify-center p-8 border border-gray-100 rounded-lg hover:border-[#25D366] hover:shadow-lg transition-all w-full md:w-64"
            >
              ...
              <p className="text-xl font-bold text-gray-900">+971 52 433 1920</p>
            </a>
            ...
            >
              ...
              <h3 className="text-[12px] font-bold uppercase tracking-widest text-gray-500 mb-2">WhatsApp (PK)</h3>
              <p className="text-xl font-bold text-gray-900">0321 5112240</p>
            </a>
          </div>
        </div>
      </section>
