...
export default function SmartSpaces() {
  return (
    <div className="min-h-screen w-full min-w-0 overflow-x-clip bg-white text-gray-900 font-sans selection:bg-[#E5E0D8]">
      <ProductPageHeader title="Breakout & Lounge Pods" description="Dynamic, collaborative, and flexible layouts designed for the modern agile workforce. Discover ergonomic seating and pods designed for peak performance and enduring comfort." />
{/* Main Content Area */}
