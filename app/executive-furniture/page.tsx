  ...
  const products = [
    {
      ...
      image: "/240(1).png",
      description: "Prestige writing desks featuring expansive worksurfaces, elegant leather writing pads, and integrated lockable storage drawers.",
    ...
    },
    {
      ...
      image: "/230 (1).png",
      description: "High-back posture executive chairs offering advanced multi-point tilt locking mechanisms and luxury padded armrests.",
    ...
    },
    {
      ...
      image: "/240(3).png",
      description: "L-shaped and return-inclusive workstations designed to integrate computers, accessories, and side table returns seamlessly.",
    ...
    },
    {
      title: "Side Cabinets",
      image: "/240(4).png",
      description: "Low-height credential sideboards built for printer storage, reference folders, and personal office storage items.",
    ...
    },
    {
      ...
      image: "/240(5).png",
      description: "Full-height executive storage wardrobes containing hanging space, open reference shelves, and glass display panels.",
    ...
    {
      title: "Reception Executive Furniture",
      image: "/240(2).png",
    ...
    },
    {
      ...
      image: "/230 (2).png",
      description: "Medium-back leather guest chairs built to bring refined luxury and comfortable posture support to boardrooms and visitor areas.",
    ...
    },
    {
      ...
      image: "/155 (15).png",
      description: "Comfortable leather and fabric sofa seating ideal for private executive office corners and visitor lounges.",
  ...
  const features = [
    {
      ...
      desc: "Every executive item is hand-finished and inspected, ensuring flawless joints, alignment, and edge detailing."
    },
    {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] text-gray-900 font-sans selection:bg-[#E5E0D8]">
      ...
      <section className="relative h-[450px] flex items-center justify-center text-center bg-[#111111] overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1000px] px-4 mt-8">
          ...
          <p className="text-gray-300 text-sm md:text-base font-medium max-w-2xl mx-auto leading-relaxed">
            Luxury office furniture crafted to reflect leadership, prestige, and sophistication.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 max-w-[1000px] mx-auto px-4 text-center">
        <h2 className="text-[11px] font-bold text-gray-500 uppercase tracking-widest mb-4">Leadership Environments</h2>
        <h3 className="text-3xl md:text-4xl font-serif text-gray-900 mb-6 font-semibold">Furniture That Defines Leadership</h3>
        ...
        <p className="text-gray-600 text-sm md:text-base leading-relaxed font-serif max-w-3xl mx-auto">
          An executive office is more than a workstation; it is a canvas of corporate culture and a private domain where strategic choices are formed. Our executive collections integrate classical prestige with modern ergonomics, creating spaces that feel highly premium, comfortable, and commanding.
        </p>
      </section>
      ...
      <section className="py-20 bg-[#FAFAFA] border-y border-gray-100">
        <div className="max-w-[1200px] mx-auto px-4">
          <div className="mb-12">
            ...
            <h3 className="text-3xl font-serif text-gray-900">Executive Collections</h3>
      ...
      <section className="bg-[#EBEBEB] py-24 text-center">
        <div className="max-w-2xl mx-auto px-4">
          <h3 className="text-3xl font-bold text-gray-900 mb-4 font-serif">Elevate Your Executive Environment</h3>
          <p className="text-gray-500 text-xs md:text-sm mb-8 leading-relaxed">
            Let us help you design and build a workspace that reflects leadership. Contact our specialist consultants today.
          </p>
          <Link 
            href="/contact" 
